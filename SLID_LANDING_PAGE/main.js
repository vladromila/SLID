    ...
    function () {
        ...
        _createClass(BuildHTML, [{
            ...
            value: function _build(text, who) {
                return "<div class=\"".concat(this.messageWrapper, " ").concat(this[who + 'Class'], "\">\n              <div class=\"").concat(this.circleWrapper, " animated bounceIn\"></div>\n              <div class=\"").concat(this.textWrapper, "\">...</div>\n            </div>");
            }
        }, {
            key: "me",
